...
public class RespaldoAutomatico extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent intentPendiente =
                PendingIntent.getBroadcast(context.getApplicationContext(), 0, intentRespaldo, 0);
        if (alarma != null) {
        ...
        Intent intentNotificacion = new Intent(context.getApplicationContext(), MainActivity.class);
